...
level: B2
description: Explain privacy, tracking, consent, personalized feeds, ads, recommendation systems, and user trust in practical product English.
---
...
**Focus:** Explain growth versus trust decisions using everyday app examples and practical product trade-offs.
...
- The product benefit is...
- The uncomfortable part is...
- I would not collect this unless...
- A simple user control is...
...
### Dialogue 1 - Data Minimization

**PM:** Can we ask for location during onboarding?

**You:**
I would only ask if location is needed at that moment. For delivery or maps, it makes sense. For a reading app, it feels excessive.

We can ask later when the user uses a location-based feature. That is more respectful and easier to explain.

### Dialogue 2 - Personalized Feed

**Product Lead:** Watch time increased after the ranking change. Is that good?

**You:**
It might be good, but watch time alone is not enough. We should also check hide rate, not-interested actions, reports, satisfaction, and whether the feed became too narrow.

Longer sessions can mean value, but they can also mean the product became harder to leave.

### Dialogue 3 - Consent UX

**Designer:** Is this consent popup fair?

**You:**
It is fair only if users can understand the choice quickly and reject it easily. If Accept is bright and Reject is hidden, the design is pushing users.
